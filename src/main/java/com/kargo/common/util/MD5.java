...
public class MD5
{
    ...
    {
        String data= "fz_api_token"+"cf92f3985a910f1dc3f5";
        MD5 md5 = new MD5();

        String strMD5=md5.getMD5ofString(data.getBytes(), data.getBytes().length);
        	System.out.println(strMD5.substring(5, 25));
